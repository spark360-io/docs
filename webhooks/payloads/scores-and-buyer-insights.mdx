...
| Value | Description |
|-------|-------------|
| `null` | Score cannot be determined. |
| 9–10  | High likelihood to perform and meet obligations. High likelihood to qualify for the best interest rates. |
| 7–8   | Likely to perform and meet obligations. Likely to qualify for most loans at slightly higher rates. |
| 5–6   | Average likelihood to perform and meet obligations. May qualify for some loans at higher rates. |
| 3–4   | Poor likelihood to perform and meet obligations. May qualify for some loans at significantly higher rates. |
| 1–2   | Unlikely to perform and meet obligations. Highly unlikely to qualify for any loans. |
